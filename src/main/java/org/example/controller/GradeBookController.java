...
public class GradeBookController {
    ...
    public @ResponseBody
    String addGrade(@RequestParam String studentId, @RequestParam String subject, @RequestParam String mark, @RequestParam String login, @RequestParam String password) {
        return gradeBookService.addGrade(studentId, subject, mark, login, password);
    }

    @PutMapping("/user/grades/change")
    public @ResponseBody
    String changeGrade(@RequestParam Long gradeId, @RequestParam String mark, @RequestParam String login, @RequestParam String password) {
        return gradeBookService.changeGrade(gradeId, mark, login, password);
    }

    @DeleteMapping("/user/grades/delete")
    public @ResponseBody
    String deleteGrade(@RequestParam Long gradeId, @RequestParam String login, @RequestParam String password) {
